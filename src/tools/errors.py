errors_mapping = {
    ...
    "30036": "عدد وارد شده کمتر از حد مجاز است.",
    ...
    "30053": "ورودی وضعیت فاکتور غیرقابل قبول است.",
    "30051": "ورودی ها را دوباره چک کنید.",
    "30054": "حد بالایی کمتر از حد پایینی وارد شده است.",
...
def get_error(type: str, code: str):
    ...
    if type == "enum":
        return {"code": 412, "message": code}
    if type == "less_than":
        return {"code": 412, "message": errors_mapping["30036"]}
